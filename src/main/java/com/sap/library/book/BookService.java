package com.sap.library.book;

import com.sap.library.common.PageResponse;
import com.sap.library.exception.OperationNotPermittedException;
import com.sap.library.file.FileStorageService;
import com.sap.library.history.BookTransactionHistory;
import com.sap.library.history.BookTransactionHistoryRepository;
import com.sap.library.user.User;
...
import static com.sap.library.book.BookSpecification.withOwnerId;
...
public class BookService {
    ...
    public Integer borrowBook(Integer bookId, Authentication connectedUser) {
        ...
        final boolean isAlreadyBorrowedByUser = transactionHistoryRepository.isAlreadyBorrowedByUser(bookId, String.valueOf(user.getId()));
